import { Search, Bell, User, TrendingUp, DollarSign, Moon, Sun } from "lucide-react";
...
export function AccountantTopBar() {
  ...
  return (
    <header className="h-16 border-b border-white/10 flex items-center justify-between px-6 bg-gradient-to-r from-blue-600 via-blue-500 to-teal-500 shadow-md">
      ...
      <div className="flex items-center gap-6">
        ...
        <div className="flex items-center gap-4 ml-4">
          <div className="flex items-center gap-2 px-3 py-1.5 bg-white/15 backdrop-blur-sm rounded-lg border border-white/20">
            ...
            <span className="text-xs text-white">ETB 285k Deposits</span>
          </div>
          <div className="flex items-center gap-2 px-3 py-1.5 bg-white/15 backdrop-blur-sm rounded-lg border border-white/20">
            <TrendingUp className="size-4 text-white" />
            <span className="text-xs text-white">23 Pending</span>
          </div>
        </div>
      </div>
