...
const navigationItems: NavigationItem[] = [
  ...
  { icon: Users, label: "Member Records", view: "member-records" },
  { icon: PiggyBank, label: "Savings Entry", view: "savings-entry" },
  { icon: Landmark, label: "Loan Management", view: "loan-management" },
  { icon: TrendingUp, label: "Share Allocation", view: "share-allocation" },
...
interface AccountantSidebarProps {
  ...
  onViewChange: (view: AccountantView) => void;
  onLogout: () => void;
}

export function AccountantSidebar({ activeView, onViewChange, onLogout }: AccountantSidebarProps) {
