  ...
  return (
    <aside className={`w-64 flex flex-col ${
      theme === 'dark'
        ...
        : 'bg-gradient-to-b from-gray-700 via-gray-800 to-gray-900 shadow-lg shadow-gray-900/20'
    }`}>
      {/* Logo/Brand Section */}
      <div className="p-6 border-b border-white/10">
        <div className="flex items-center gap-3">
          <div className={`size-10 rounded-xl flex items-center justify-center shadow-lg ${
            ...
            <span className={`${theme === 'dark' ? 'text-teal-300' : 'text-gray-800'}`} style={{ fontFamily: "'Inter', system-ui, sans-serif", fontWeight: 700 }}>SC</span>
          </div>
          <div>
            <h2 className="text-white text-sm" style={{ fontFamily: "'Inter', system-ui, sans-serif", fontWeight: 600 }}>SACCO</h2>
            <p className={`text-xs ${theme === 'dark' ? 'text-gray-400' : 'text-gray-300'}`}>Committee Portal</p>
          </div>
        </div>
      </div>
